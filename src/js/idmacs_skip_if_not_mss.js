...
/**
 * Checks whether the current database platform is Microsoft.
 ...
 *   nothing
 */
function idmacs_skip_if_not_mss(){
	var SCRIPT = "idmacs_skip_if_not_mss: ";

	var lv_dbtype = "%$ddm.databasetype%";
	idmacs_trace(SCRIPT + "lv_dbtype = " + lv_dbtype);

	//If database type is not MSS
	if(lv_dbtype != "1")
	{
		//Skip this pass
		uSkip(2);
