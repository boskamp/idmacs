...
/**
 * Emits an ERROR message to the persistent log. The message
 * will be passed to uError to be recorded in the regular job log,
...
function idmacs_error(iv_message){
    idmacs_trace(iv_message, "e");
    uError(iv_message);
}
