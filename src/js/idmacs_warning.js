...
/**
 * Emits an WARNING message to the persistent log. The message
 * will be passed to uWarning to be recorded in the regular job log,
...
function idmacs_warning(iv_message){
    idmacs_trace(iv_message, "w");
    uWarning(iv_message);
}
